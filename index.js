...
var exports_iconsAndAliases = {};
__export(exports_iconsAndAliases, {
  ZoomOut: () => ZoomOut,
  ZoomIn: () => ZoomIn,
  ZapOff: () => ZapOff,
  Zap: () => Zap,
...
class WireIcon extends BaseComponent {
  ...
  render() {
    ...
    try {
      ...
      const IconComponent = exports_lucide[formattedName] || Circle;
      if (IconComponent) {
      ...
      const svgElement = createElement(Circle, {
        width: size,
        height: size,
        stroke: "currentColor",
        "stroke-width": "2",
